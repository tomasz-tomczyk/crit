...
func BuildPlanDaemonArgs(currentPath, storageDir, slug string, flags PlanDaemonFlags) []string {
	args := appendPlanDaemonFlags(nil, flags)
...
// ApplyPlanOverrides configures a session for plan mode.
