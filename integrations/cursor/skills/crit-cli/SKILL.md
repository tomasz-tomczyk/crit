  ...
  "review_comments": [
    {
      ...
      "resolved": false,
      "replies": [
        { "id": "r0-r1", "body": "Thanks, addressed the minor issues", "author": "Cursor" }
      ]
    }
  ],
  "files": {
      ...
      "comments": [
        {
          ...
          "resolved": false,
          "replies": [
            { "id": "c1-r1", "body": "Fixed by extracting to helper", "author": "Cursor" }
          ]
        }
      ]
    }
...
```bash
crit comment --reply-to c1 --author 'Cursor' 'Fixed by extracting to helper'
crit comment --reply-to r0 --author 'Cursor' 'All issues addressed'
```
...
crit comment --reply-to c1 --author 'Cursor' 'Added null check on line 42'
crit comment --reply-to r0 --author 'Cursor' 'All issues addressed'
```
