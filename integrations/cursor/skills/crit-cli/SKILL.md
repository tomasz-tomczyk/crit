...
crit comment --reply-to r0 --resolve --author 'Cursor' 'All issues addressed'
```
...
Note: Cursor headless mode is experimental and may hang. If it does, use the standard review-and-finish workflow instead.
