...
4. Reply to the comment with what you did: `crit comment --reply-to <id> --author 'Cursor' '<what you did>'` (reply bodies support markdown — use code fences and inline code where helpful)
