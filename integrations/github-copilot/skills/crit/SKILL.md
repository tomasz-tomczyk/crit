...
4. Reply to the comment with what you did: `crit comment --reply-to <id> --author 'GitHub Copilot' '<what you did>'` (reply bodies support markdown — use code fences and inline code where helpful)
