...
```bash
crit comment --reply-to c1 --resolve --author 'Codex' 'Fixed by extracting to helper'
crit comment --reply-to r0 --resolve --author 'Codex' 'All issues addressed'
```
...
crit comment --reply-to c1 --resolve --author 'Codex' 'Added null check on line 42'
crit comment --reply-to r0 --resolve --author 'Codex' 'All issues addressed'
```
