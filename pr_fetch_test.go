...
// TestIsStackedPR is the truth-table for IsStackedPR(*PRInfo, VCS), exercised
// with a fake VCS so it runs without a real repo. P-3 / playwright reviewer
...
// fakeStackVCS implements VCS just enough for IsStackedPR/ensureSHAFetched tests.
