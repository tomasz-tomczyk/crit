// Package main is the live-mode E2E upstream fixture.
// Single-file deterministic HTTP server with 9 routes used by the
// live-mode Playwright project. See plans/2026-05-06-live-mode-phase-f-e2e.md.
package main
...
func main() {
	...
	// Stable stdout contract used by setup-fixtures-livemode.sh.
...
// a shadow-DOM host. Used by agent.livemode.spec for suppression carve-outs
