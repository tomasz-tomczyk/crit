...
#
# Usage: ./test/shell/test-diff.sh [port]
#
...
CF_FILE_PORT=$((PORT + 2))
CF_FILE="test/shell/carry-forward-copy.md"
cp test/shell/carry-forward-v1.md "$CF_FILE"
...
cp test/shell/carry-forward-v1.md "$CF_GIT_DIR/plan.md"
...
cp test/shell/test-plan-v2.md "$FILE"
...
cp test/shell/carry-forward-v2.md "$CF_FILE"
cp test/shell/carry-forward-v2.md "$CF_GIT_DIR/plan.md"
sleep 1.5
