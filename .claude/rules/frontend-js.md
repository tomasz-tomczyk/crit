...
- Off-screen file-body deferral (IntersectionObserver mount) stays separate: it skips mounting bodies until near the viewport. Do not reintroduce a per-diff Load Diff click gate — row virtualization makes mounted bodies cheap.
