...
// Set up the globals before requiring live-mode.row.js.
...
const { chipLabel, renderLivePinRow } = require('../live-mode.row.js');
...
// Minimal DOM stub for renderLivePinRow tests that need to exercise the
...
test('renderLivePinRow includes a Delete button on top-level comment cards', () => {
  ...
  // Stub shared card so renderLivePinRow takes the real (non-fallback) path.
